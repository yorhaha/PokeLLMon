...
parser.add_argument(
    ...
    choices=["gpt-3.5-turbo-0125", "gpt-4-1106-preview", "gpt-4-0125-preview"],
)
...
async def main():
    ...
    llm_player._dynamax_disable = (
        True  # If you choose to disable Dynamax for PokeLLMon, please do not use Dynamax to ensure fairness.
    )
